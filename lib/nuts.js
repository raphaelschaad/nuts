...
function getFullUrl(req) {
    // Precautiously force HTTPS (vs. `req.protocol`) to prevent potential Apple Transport Security (ATS) errors in Electron clients.
    // Nuts might return HTTP URLs when deployed to heroku: https://medium.com/@connorlurring/fixing-nuts-auto-updates-for-our-electron-app-64beeed8b14
